...
import { SBItem } from "../../components/componentLib/SBItem";
import SButton from "../../components/componentLib/SButton";
import { ElementsText } from "../../components/constants";
...
function Index() {
  ...
  const data = React.useRef<number[]>([...Array.from(new Array(6).keys())]).current;
  const viewCount = 5;
