...
const EditClientModal: React.FC<EditClientModalProps> = ({
  ...
  const [client, setClient] = React.useState<Client>({
    name: Customer.Name || "",
    email: Customer.MainDeliveryContact_Email || "",
    phone: Customer.MainDeliveryContact_CellPhone || "",
    addressType: "Livraison",
    address: Customer.MainDeliveryAddress_Address1 || "",
    postalCode: Customer.MainDeliveryAddress_ZipCode || "",
    city: Customer.MainDeliveryAddress_City || "",
    note: Customer.NotesClear || "",
  });
